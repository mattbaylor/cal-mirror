...
enum RequestCopy {
    ...
    enum Offer {
        ...
        static let network = "Loading the price is this app’s first contact with anyone — Apple, for the price in your currency. AskWhen.me hears nothing until you check a name below."
        ...
        static let nameAsk = "Your name on AskWhen.me"
        static let nameField = "dana"
        static let nameCheck = "Check it"
        static let nameChecking = "Asking AskWhen.me…"
        static let nameFree = "%@ is free. Subscribe now and it is yours."
        static let nameTaken = "%@ is already somebody’s. Try another."
        static let nameInvalid = "%@"
        static let nameFailed = "Could not ask whether that name is free. You can still subscribe and choose from your page."
        static let nameOptional = "Optional. You can also pick a name later, from your page — checking here only means you find out before you pay, instead of after."
        static let nameHolding = "Keeping %@ for you…"
        static let nameLost = "%@ went while you were deciding, so nothing was bought. Try another name."
        static let nameClaimFailed = "Your subscription is fine. %@ could not be claimed just now — take it from the Address section of your page."
