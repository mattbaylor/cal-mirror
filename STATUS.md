...
| 20a | ~~**Send times · personal links · zero-decision setup**~~ — **decided 16 Sept: all three are in 2.0**, after the native pass, in that order. `decisions.md`, *Settled*. **Send times built 16 Sept** (row, menu item, intent); personal links and setup next. |
