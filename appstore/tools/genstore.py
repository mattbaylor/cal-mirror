...
FRAMES = [
    ...
    # 6 — tags: the last of the mirror features, so the copy story finishes before 2.0 starts
    ...
    # 7 — the warning closes the mirror story
    dict(kind="shot", grad=G_BLUE,
         ...
         crop=dict(ipad=(0, 0, 2064, 1465))),
    # 8 — 2.0. Send times: the daily-use one. The phone shows the share sheet with the line; iPad and Mac say it in words (the Mac's is a menu item, and no capture of a menu is made).
    dict(kind="shot", grad=G_DEEP,
         ...
         ipad_swap=dict(kind="list", grad=G_DEEP,
                        head="When are you free? Answer from the app.",
         ...
         mac_swap=dict(kind="list", grad=G_DEEP,
